    ...
    return (
      <div className="main-content">
        <div className="content-block top-block">
            ...
            <Button className="search-btn" type="primary" icon="search" onClick={() => this.reqQpsData(1)}>查询</Button>
        </div>
        <div className="content-block">
        	<Charts title={"吞吐率走势图"} loading={this.state.loading} option={this.state.chartOption}/>
          	<Card title="吞吐率说明">
            	<p>单位时间执行的命令数</p>
          	</Card>
        </div>
